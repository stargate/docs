...
and tuples. Columns can be set to these data types in the original table creation,
or be added later. Look in the next section for some examples of adding columns.
// end::DataTypes[]
...
Examples of `set`, `list`, `map`, and `tuple` are shown, using the column
