...
6. CAN'T DO(bookByIsbn) Look up a book by ISBN (clustering column). _Book_
...
11. CAN'T DO(readerByUserid) Look up a reader by user_id (clustering column). _Reader_
