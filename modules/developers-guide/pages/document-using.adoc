...
[source,bash]
----
include::example$bash/curl_docapi_simple_namespace.sh[]
----
...
[source,bash]
----
include::example$bash/curl_docapi_set_namespace_replicas.sh[]
----
...
[source,bash]
----
include::example$bash/curl_docapi_namespace_dcs.sh[]
----
// end::CreateNSextra[]
...
[source,shell]
----
include::example$bash/curl_docapi_check_ns_exists.sh[]
----
--
...
[source,plaintext]
----
include::example$result/curl_check_ns_exists.result[]
----
--
====
...
[source,bash]
----
include::example$bash/curl_docapi_get_particular_ns.sh[]
----
