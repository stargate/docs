...
In order to use the Document API, you must create the namespace
that will store the data. A namespace is a container for which a
`replicas` defines the number of data replicas the database will store.
...
[source, plaintext]
----
{"data":{"350041bd-5e41-421b-9b3b-f021921851ce":{"firstname":"Joey","lastname":"Doe","weights":{"reps":15,"type":"bench press","weight":150}}},"pageState":null}
----
...
[source, plaintext]
----
{"documentId":"350041bd-5e41-421b-9b3b-f021921851ce","data":{"firstname":"Joey","lastname":"Doe","weights":{"reps":10,"type":"squat","weight":350}}}
----
...
[source,bash]
----
curl -L -X PATCH 'localhost:8082/v2/namespaces/myworld/collections/fitness/350041bd-5e41-421b-9b3b-f021921851ce' \
--header "X-Cassandra-Token: $AUTH_TOKEN" \
--header 'Content-Type: application/json' \
-d '{"firstname": "Jane"}'
----
...
[source,bash]
----
curl -L -X PATCH 'http://localhost:8082/v2/namespaces/myworld/collections/fitness/350041bd-5e41-421b-9b3b-f021921851ce/weights' \
--header "X-Cassandra-Token: $AUTH_TOKEN" \
--header 'Content-Type: application/json' \
--data '{
    "reps": 20,
