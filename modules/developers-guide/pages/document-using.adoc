...
[source,bash]
----
include::example$bash/curl_simple_namespace.sh[]
----
...
[source,bash]
----
include::example$bash/curl_set_namespace_replicas.sh[]
----
...
[source,bash]
----
include::example$bash/curl_namespace_dcs.sh[]
----
// end::CreateNSextra[]
...
[source,shell]
----
include::example$bash/curl_check_ns_exists.sh[]
----
--
