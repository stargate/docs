...
We've provided a
https://github.com/stargate/docs/blob/master/modules/developers-guide/examples/docapi/Stargate_Document_API_users.postman_collection.json[Stargate Document API Postman Collection]
...
[source, bash]
----
include::example$docapi/curl_drop_ns.sh[]
----
// end::DeleteNS[]
...
// LLP: add example
// include::example$docapi/curl_get_doc_path_array.sh
