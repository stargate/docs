...
Refer to the official link:https://stargate.io/docs/[Stargate documentation]
...
Here is one example of starting a Cassandra cluster and launching Stargate using
the link:https://github.com/riptano/ccm[Cassandra Cluster Manager (CCM)]:

[source, shell]
----
include::example$bash/start-sg-ccm.sh[]
----
