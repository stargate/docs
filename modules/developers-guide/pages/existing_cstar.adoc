...
include::partial$quick_start-rest.adoc[tag=getDockerImage,leveloffset=+1]

include::partial$text/docker_run_existing_cstar.sh[]
...
of a containerized environment, see the xref:install/starctl.adoc[starctl] documentation.
