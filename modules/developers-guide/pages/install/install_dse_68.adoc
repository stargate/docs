...
* If you already have Cassandra running in a xref:docker_compose_dse_68[docker-compose application], or want
...
include::install_vm_cstar_dse_68.adoc[Virtual machine or bare metal]
