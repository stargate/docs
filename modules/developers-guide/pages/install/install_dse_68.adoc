...
CAUTION: At this time Stargate does not support advanced workloads such as Graph and Search. If you are 
using any sort of search index in the keyspace you plan to use with Stargate they will need to be removed
before Stargate deployment.
