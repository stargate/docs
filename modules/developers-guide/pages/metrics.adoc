...
to `localhost:8085` (the Stargate node and metrics port).
...
Add Prometheus as a data source, and all the Stargate metrics will be available
to add to a http://grafana.com/oss/grafana[Grafana] dashboard.
