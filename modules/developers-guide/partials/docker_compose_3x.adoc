...
https://github.com/stargate/docker-images/tree/master/examples/stargate-cass311[https://github.com/stargate/docker-images/tree/master/examples/stargate-cass311]
...
see the xref:install_existing_cass_3x.adoc[Installing on VMs or bare metal] documentation.
