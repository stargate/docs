...
https://github.com/stargate/docker-images/tree/master/examples/stargate-dse68[https://github.com/stargate/docker-images/tree/master/examples/stargate-dse68]
