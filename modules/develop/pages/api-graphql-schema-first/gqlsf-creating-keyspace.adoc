...
In order to use the GraphQL API, you must xref:graphql-first-using.adoc#deploy-schema[deploy schema]
...
[source, plaintext]
----
include::example$graphql/schema-first/createKeyspace.graphql[]
----
