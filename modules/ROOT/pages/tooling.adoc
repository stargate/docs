...
* https://github.com/stargate/docs/blob/main/modules/developers-guide/examples/json/Stargate-Astra-API-Environment.postman_environment.json[Astra environment]
* https://github.com/stargate/docs/blob/main/modules/developers-guide/examples/json/Stargate-OSS-API-Environment.postman_environment.json[Stargate OSS environment]
