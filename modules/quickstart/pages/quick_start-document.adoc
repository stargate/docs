...
If you prefer, you can use Postman as a client interface for exploring the
Document API (https://www.postman.com/downloads/[download here]).
// LLP: NEED TO REPLACE THIS
We've provided a
https://github.com/stargate/docs/blob/master/modules/developers-guide/examples/stargate-document-api.postman_collection.json[Stargate Document API Postman Collection]
