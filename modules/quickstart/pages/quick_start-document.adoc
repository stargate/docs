...
// tag::prereqsList[]
include::developers-guide:partial$text/prereqs.adoc[]
// end::prereqsList[]

// tag::getDockerImage[]
include::developers-guide:partial$bash/docker_pull.sh[]
// end::getDockerImage[]

// tag::startDocker[]
include::developers-guide:partial$bash/docker_run.sh[]
// end::startDocker[]
...
include::developers-guide:partial$bash/gen_auth_token.sh[]

// tag::UseAuthToken[]
include::developers-guide:partial$bash/use_auth_token_rest_document.sh[]
