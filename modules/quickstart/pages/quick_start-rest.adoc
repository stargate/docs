...
include::develop:page$dev-with-doc.adoc[tag=UseAuthToken]
...
We've provided a
https://github.com/stargate/docs/blob/master/modules/develop/examples/json/Stargate_REST_v2_API_users_keyspace.postman_collection.json[Stargate REST API Postman Collection] that you can import in Postman to play with the examples shown in this walkthrough.
