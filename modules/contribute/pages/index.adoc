...
All bugs and enhancements for the Stargate documentation are tracked using the {url-issues-doc}[DOC project issue board^].
...
Remember, the documentation team are not experts in every aspect of Stargate.
