...
The Stargate documentation is stored in multiple repositories that are organized in a standard directory structure.

[#repo-urls]
== Documentation Repository Roster

The Stargate documentation is stored several organizations and multiple repositories on GitHub.
...
Some Stargate repositories only accept contributions via Gerrit, use custom branch patterns, and have additional content and AsciiDoc requirements.
...
Additionally, the AsciiDoc files in these repositories are used to create two sets of documentation: 1. the CLI and Backup pages incorporated in the Stargate Server component and, 2., standalone man pages that are bundled with the Server software.
