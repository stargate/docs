...
The Stargate documentation repositories maintain two types of base branches: master and release.

For Stargate Server, SDKs, and Mobile docs, the default branch will be the latest release -- e.g. release/6.6.
