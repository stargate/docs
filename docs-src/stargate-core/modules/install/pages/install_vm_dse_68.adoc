...
https://docs.datastax.com/en/dse/6.8/dse-dev/datastax_enterprise/config/configCassandra_yaml.html#configCassandra_yaml__authenticator[cassandra.yaml,window="_blank"] file.
If you don't have a cluster running, use these instructions to install
https://docs.datastax.com/en/install/6.8/install/installWhichOne.html[DSE 6.8,window="_blank"].

Next, prepare a virtual machine to install Stargate on. You'll need to be sure
Java 8 is installed.

Once you have a machine ready,
download the https://github.com/stargate/stargate/releases/download/{stargate-docker-tag-68}/stargate-jars.zip[Stargate zip file,window="_blank"].
