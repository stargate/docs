...
script,window="_blank"] is available to run Apache Cassandra^(TM)^, Stargate, Prometheus, and Grafana
...
== Access Prometheus
Once all the images are running, you can access https://prometheus.io/[Prometheus,window="_blank"] in the browser at
...
accessed in https://prometheus.io[Prometheus,window="_blank"].

== Access Grafana
Once all the images are running, you can access https://grafana.com/oss/grafana[Grafana,window="_blank"] in the browser at
...
For more information on using Grafana, access the https://grafana.com/docs/[Grafana docs,window="_blank"].
