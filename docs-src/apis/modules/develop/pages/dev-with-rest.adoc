...
If you prefer to learn using a QuickStart, try out the xref:quickstart:quick_start-rest.adoc[Stargate REST QuickStart, window="_blank"].
To view the API Reference, see xref:ROOT:attachment$restv2.html[{database} REST API, window="_blank"].
