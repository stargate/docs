...
include::develop:page$api-doc/doc-creating-namespace.adoc[Creating a namespace, leveloffset=+1]
endif::[]

include::develop:page$api-doc/doc-checking-namespace.adoc[Checking for namespace, leveloffset=+1]

// STARGATE ONLY
ifeval::["{product}" == "Stargate"]
include::develop:page$api-doc/doc-deleting-namespace.adoc[Deleting a namespace, leveloffset=+1]
endif::[]
