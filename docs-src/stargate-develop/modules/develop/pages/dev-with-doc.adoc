...
To view the API Reference, see the link:https://stargate.io/docs/latest/develop/attachments/docv2.html[Stargate Document API^].

// xref:develop:attachment$docv2.html[{database} Document API, window="_blank"].
