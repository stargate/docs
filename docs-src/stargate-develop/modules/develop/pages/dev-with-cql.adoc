...
ifeval::["{product}" == "Astra DB for DSE"]
include:connect:connecting-to-astra-databases-using-cqlsh.adoc[]
endif::[]
...
For example, to connect to {product} running on your local machine using the Python driver, replacing the IP address with an appropriate address:
