...
* https://github.com/datastax/java-driver[Java,window="_blank"]
* https://github.com/datastax/csharp-driver[C#,window="_blank"]
* https://github.com/datastax/cpp-driver[C++,window="_blank"]
* https://github.com/datastax/python-driver[Python,window="_blank"]
* https://github.com/datastax/nodejs-driver[Node.js,window="_blank"]
* https://github.com/gocql/gocql[Go,window="_blank"]
* https://spring.io/projects/spring-data-cassandra[Spring Data Cassandra,window="_blank"]
...
https://docs.datastax.com/en/devapp/doc/devapp/driversLoadBalancing.html[Load Balancing Policy,window="_blank"]
...
ifeval::["{database}" == "Stargate"]
Use the Stargate node as the contact point when connecting using Cassandra drivers, and use the https://docs.datastax.com/en/devapp/doc/devapp/driversLoadBalancing.html[Round Robin load balancing policy,window="_blank"].
endif::[]
