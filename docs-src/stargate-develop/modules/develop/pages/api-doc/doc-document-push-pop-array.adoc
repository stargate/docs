...
----
include::example$docapi/library/curl-ns-get-functions.sh[]
----
--
...
[source, shell, subs="attributes+"]
----
include::example$docapi/library/curl-document-get-array-change.sh[]
----
--
...
[source, shell, subs="attributes+"]
----
include::example$docapi/library/curl-document-post-push-book.sh[]
----
--
...
[source, shell, subs="attributes+"]
----
include::example$docapi/library/curl-document-post-pop-book.sh[]
----
--
