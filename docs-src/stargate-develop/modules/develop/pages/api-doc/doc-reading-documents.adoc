...
include::develop:page$api-doc/doc-document-decoration.adoc[leveloffset=+1]

include::develop:page$api-doc/doc-document-simple-where.adoc[leveloffset=+1]
...
[source,shell, subs="attributes+"]
----
include::example$docapi/curl-document-get-one.sh[]
----
--
