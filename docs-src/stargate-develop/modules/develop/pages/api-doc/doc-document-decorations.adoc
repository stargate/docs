...
----
include::example$docapi/library/curl-document-get-6.sh[]
----
--
...
[source,shell, subs="attributes+"]
----
include::example$docapi/library/curl-document-get-all-docs-with-paging.sh[]
----
--
...
[source,shell, subs="attributes+"]
----
include::example$docapi/library/curl-document-get-one-with-fields.sh[]
----
--
