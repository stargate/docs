...
include::develop:partial$GQLNaming.adoc[leveloffset=1]
...
ifeval::["{product}" == "Stargate"]
include::develop:page$api-graphql-cql-first/gql-creating-keyspace.adoc[leveloffset=+1]
endif::[]

include::develop:page$api-graphql-cql-first/gql-checking-keyspace.adoc[leveloffset=+1]

ifeval::["{product}" == "Stargate"]
include::develop:page$api-graphql-cql-first/gql-deleting-keyspace.adoc[leveloffset=+1]
endif::[]

include::develop:page$api-graphql-cql-first/gql-schema-data-types.adoc[Schema and data types,leveloffset=+1]
